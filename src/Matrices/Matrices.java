...
public abstract class Matrices {
     ...
     */
    public static Matrix add(Integer[][] matrix1, Integer[][] matrix2) {
        ...
        return new Matrix(new Integer[0][0]);
    }
    ...
    public static Matrix add(Matrix matrix1, Matrix matrix2) {
        Integer[][] m1 = matrix1.getMatrix();
        Integer[][] m2 = matrix2.getMatrix();
        return add(m1, m2);
    }
     ...
     */
    public static Matrix subtract(Integer[][] matrix1, Integer[][] matrix2) {
    ...
    public static Matrix multiply(Matrix matrix1, Matrix matrix2) throws Exception {
        ...
        Integer[][] m3 = new Integer[matrix1.getRows()][matrix2.getColumns()];
     ...
     */
    public static Matrix multiply(Integer[][] m1, Integer[][] m2) throws Exception {
